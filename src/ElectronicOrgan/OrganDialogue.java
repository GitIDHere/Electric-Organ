...
public class OrganDialogue {
  ...
  */
  ...
  public int getWaveform () {
    if (frame.sineButton.isSelected ()) return SINE_WAVEFORM;
    if (frame.squareButton.isSelected ()) return SQUARE_WAVEFORM;
    if (frame.sawtoothButton.isSelected ()) return SAWTOOTH_WAVEFORM;
    if (frame.triangleButton.isSelected ()) return TRIANGLE_WAVEFORM;
